      ...
      <div className="flex-1 flex justify-center items-center p-10">
        <div className="w-full max-w-lg bg-white shadow-xl rounded-2xl p-8">
          ...
          <label
            ...
            ${payment === "card" ? "border-green-500 bg-green-50 shadow" : "hover:border-gray-400 hover:bg-gray-300"}`}
          >
          ...
          <label
            ...
            className={`flex flex-col cursor-pointer border rounded-xl p-4 mb-4 transition
            ${payment === "upi" ? "border-green-500 bg-green-50 shadow" : "hover:border-gray-400  hover:bg-gray-300"}`}
          >
            <div className="flex items-center gap-3 font-medium">
              📱 UPI Payment
            </div>
          ...
          <label
            ...
            ${payment === "cod" ? "border-green-500 bg-green-50 shadow" : "hover:border-gray-400  hover:bg-gray-300"}`}
          >
            <div className="flex items-center gap-3 font-medium">
              💵 Cash on Delivery
            </div>
